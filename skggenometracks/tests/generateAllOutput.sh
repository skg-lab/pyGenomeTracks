...
./bin/sgt  --tracks ./skggenometracks/tests/test_data/methylation_rate_graph_ucsc.ini  --region chrX:49,248,436-49,266,826 --outFileName ./skggenometracks/tests/test_data/methylation_rate_graph_with_genes_ucsc.pdf